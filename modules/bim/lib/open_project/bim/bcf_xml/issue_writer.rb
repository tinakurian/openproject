...
module OpenProject::Bim::BcfXml
  class IssueWriter
    ...
    def update
      # Generate initial empty markup unless present
    ...
    def replace_comments
      ...
      Nokogiri::XML::Builder.with(markup_node).new do |xml|
        comments xml
      end
    end
    ...
    def comments(xml)
      ...
      work_package.journals.select(:id, :notes, :created_at).map do |journal|
