...
export class WorkPackageCreateService implements IWorkPackageCreateService {
  ...
  constructor(protected injector:Injector,
              ...
              protected readonly wpTableFilters:WorkPackageTableFiltersService,
  ...
  public cancelCreation(workPackage:WorkPackageResource) {
    this.wpEditing.stopEditing(workPackage.id);
  }
  ...
  public createOrContinueWorkPackage(projectIdentifier:string, type?:number) {
    ...
    if (type) {
      changesetPromise = this.continueExistingEdit(type);
    }
  ...
  private applyDefaults(changeset:WorkPackageChangeset, wp:WorkPackageResource, except:string[]) {
    const filter = new WorkPackageFilterValues(this.injector, changeset, this.wpTableFilters.current, except);
